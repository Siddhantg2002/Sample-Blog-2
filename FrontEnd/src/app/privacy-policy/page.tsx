const PrivacyPolicy = () => {
  return (
    <section className="px-60 py-24 mx-auto max-w-7xl">
      ...
      <div className="mx-auto prose">
        <h2 className="text-lg font-bold underline mt-10" id="1legalnotices">1. Legal Notices</h2>
        ...
        <h2 className="text-lg font-bold underline mt-10" id="2permittedandprohibiteduses">
        ...
        <h2 className="text-lg font-bold underline mt-10" id="3usersubmissions">3 User Submissions</h2>
        ...
        <h2 className="text-lg font-bold underline mt-10" id="4userdiscussionlistsandforums">
        ...
        <h2 className="text-lg font-bold underline mt-10" id="5useofpersonallyidentifiableinformation">
        ...
        <h2 className="text-lg font-bold underline mt-10" id="6indemnification">6. Indemnification</h2>
        ...
        <h2 className="text-lg font-bold underline mt-10" id="7termination">7. Termination</h2>
        ...
        <h2 className="text-lg font-bold underline mt-10" id="8warrantydisclaimer">8. WARRANTY DISCLAIMER</h2>
        ...
        <h2 className="text-lg font-bold underline mt-10" id="9general">9. General</h2>
        ...
        <h2 className="text-lg font-bold underline mt-10" id="10linkstoothermaterials">10. Links to Other Materials</h2>
